...
#[ORM\Entity]
#[ORM\Table(name: 'catalog_group_characteristic')]
class CatalogGroupCharacteristic implements ResourceInterface, TimestampableInterface
{
    ...
    #[ORM\JoinColumn(name: 'catalog_group_id', referencedColumnName: 'id', nullable: false)]
