...
class Sort
{
    public static array $map = [
        'catalog_characteristics' => [
            'name' => 'Сортировка характеристик каталогов',
            'noSelectEntity' => 'Сортировка характеристик каталога по позиции зависит от каталога, выберите каталог и попробуйте ещё раз',
            'btnName' => 'Позиция характеристик'
        ],
        'catalog_items' => [
            'name' => 'Сортировка продуктов',
            'noSelectEntity' => 'Сортировка продукта по позиции зависит от каталога, выберите каталог и попробуйте ещё раз',
            'btnName' => 'Позиция продукта'
        ],
        'catalog_item_characteristics' => [
            'name' => 'Сортировка характеристик продуктов',
            'noSelectEntity' => 'Сортировка характеристик продукта по позиции зависит от продукта, выберите продукта и попробуйте ещё раз',
            'btnName' => 'Позиция продукта'
        ],
        'catalog_item_images' => [
        ...
        'catalog_groups' => [
        'name' => 'Сортировка групп каталогов',
        'noSelectEntity' => 'Сортировка групп каталога по позиции зависит от каталога, выберите каталог и попробуйте ещё раз',
        'btnName' => 'Позиция групп'
        ],
    ];
